<template>
  ...
  <path class="path" id="lineAB" v-bind:d="lineDraw" stroke="red"
...
<div class="container">
  ...
  <button class="m-2 btn btn-primary"  v-on:click="drawEngPath">
      Engineering
  </button>
...
export default {
  ...
  //   var v = this;
  //   setTimeout ( function() {
  //    console.log('triigerer');
  //    v.polyDraw = v.designLabPath; 
  //  },3);
  },
  computed(){
